...
public abstract class TitleBar extends UsefulViewGroup {
     ...
     * @param h           他的高。
     */
    protected abstract void onSizeChangeSafely(TitleBar titleBar,
                                               int w, int h);

    protected abstract void onAdjustViews(TitleBar titleBar, int w, int h) ;
