package zmn.w.uiutility.activity;
...
import static wclass.android.util.DeviceUT.jumpToUserInfo;
            ...
            public void onClick(View view, int number) {
                switch (number) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        jumpToUserInfo(MainActivity.this, 1);
                        break;
                    case 4:
                        ...
                        InterceptFrameVG root = hand.getRoot();
                        Rect r = new Rect();
