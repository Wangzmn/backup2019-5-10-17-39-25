...
//        //高--匹配父容器。宽--权重为1。
//        LinearLayout.LayoutParams p = ViewUT.makeLinearLayoutParams(0, MATCH_PARENT,
//                1);
...
//        LinearLayout.LayoutParams p1 = ViewUT.makeLinearLayoutParams(MATCH_PARENT
//                , 0, 1);
...
//        LinearLayout.LayoutParams p2 = ViewUT.makeLinearLayoutParams(0, MATCH_PARENT,
//                4);
...
//        progressBar.setVisibility(View.INVISIBLE);
//        FrameLayout.LayoutParams p3 = ViewUT.makeFrameLayoutParams(WRAP_CONTENT, WRAP_CONTENT, Gravity.CENTER);
